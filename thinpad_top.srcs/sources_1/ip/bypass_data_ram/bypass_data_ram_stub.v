...
// Command     : write_verilog -force -mode synth_stub -rename_top bypass_data_ram -prefix
//               bypass_data_ram_ bypass_addr_ram_stub.v
...
module bypass_data_ram(a, d, dpra, clk, we, dpo)
