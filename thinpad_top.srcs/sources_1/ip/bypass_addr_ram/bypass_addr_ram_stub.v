...
// Command     : write_verilog -force -mode synth_stub -rename_top bypass_addr_ram -prefix
//               bypass_addr_ram_ bypass_addr_ram_stub.v
...
module bypass_addr_ram(a, d, dpra, clk, we, dpo)
